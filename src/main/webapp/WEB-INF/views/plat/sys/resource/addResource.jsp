...
<div class="page-content">
    ...
    <div class="column">
        <div class="col-xs-12">
            <form id="resouceForm" name="resouceForm" class="form-horizontal" action="addResource" method="post">
                <div class="form-group">
                    <label class="col-sm-4 control-label">资源名称：</label>
                    <div class="col-sm-8">
                        <input id="resourceName" name="resourceName" type="text" class="col-xs-10 col-sm-5" placeholder="" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="resourceUrl" type="text" name="resourceUrl" class="col-xs-10 col-sm-5" placeholder="" value="">
                        <label id="resourceUrlTip"></label>
                    </div>
                </div>
                <div class="form-group" id="divTarget">
                    <label class="col-sm-4 control-label">操作目标：</label>
                    <div class="col-sm-8 ">
                ...
                <div class="form-group" id="divIconImg">
                    ...
                    <div class="col-sm-8">
                        <input id="icon" type="text" name="icon" class="col-xs-10 col-sm-5" placeholder="" value="">
                        <span class="input-group-btn">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="description" type="text" name="description" class="col-xs-10 col-sm-5" placeholder="" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="displayOrder" type="text" name="displayOrder" class="col-xs-10 col-sm-5" placeholder="" value="">
