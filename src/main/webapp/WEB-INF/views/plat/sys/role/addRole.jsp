...
<div class="page-content">
    <div class="page-header">
        <h1>
            角色管理
            <small><i class="ace-icon fa fa-angle-double-right"></i> 新增角色</small>
        </h1>
    </div>
    <!-- /.page-header -->
    <div class="row">
        <div class="col-xs-12">
            <form id="roleForm" name="roleForm" class="form-horizontal" action="addRole" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <input id="roleCode" name="roleCode" type="text" class="col-xs-10 col-sm-5" placeholder="" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <input id="roleName" name="roleName" type="text" class="col-xs-10 col-sm-5" placeholder="" value="">
                                                    ...
                                                    <c:forEach items="${listResource }" var="sysFunction" varStatus="st">
                                                        <c:if test="${sysFunction.parentId eq secModule.resourceId }">
                                                            <label class="checkbox inline" style="color: blue">
                                                                <input name="function" id="function_${sysFunction.resourceId }" type="checkbox" value="${sysFunction.resourceId }" class="ace children" />
